...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.SIDLayout = QtWidgets.QVBoxLayout()
        self.SIDLayout.setSpacing(0)
        self.SIDLayout.setContentsMargins(0, 0, 0, 0)
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.lblAnzeige = QtWidgets.QLabel()
...
"background-color: rgba(255, 255, 255, 0); border: none;")
        ...
        self.scene1 = QtWidgets.QGraphicsScene(self.view1)
        self.view1.setScene(self.scene1)
        self.view1.rotate(90)
        self.scene1.addWidget(self.lblAnzeige)

        self.gridLayout.addWidget(self.view1, 5, 5, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
...
"")
    ...
    def StatusBar(self):
        ...
        self.Hlayout.addWidget(self.xAxis)
        self.Hlayout.addWidget(self.yAxis)
